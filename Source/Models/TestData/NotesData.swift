...
//  Copyright © 2021 Ameya Bhagat. All rights reserved.
//

import Foundation

public var notesData : [Notes] = [
    Notes(title: "This is the title of the note", body: "This is were the description\n of the note will be written"),
    ...
    Notes(title: "How this is going to go?", body: "This app business is a bit tough, but the whole puzzle solving stuff is really attractive.\n That being said there are some frustrating days, where I feel like this is my limit, can't go ahead with it. Then I find the limitation was the method I was pursuing. Then I get positive vibes as in, at least there are ton more ways to find the solution and I have definitely eliminated one of them. Cheers!"),
